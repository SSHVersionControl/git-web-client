...
-- Schema version-control
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `version-control` DEFAULT CHARACTER SET utf8 ;
USE `version-control` ;

-- -----------------------------------------------------
-- Table `version-control`.`ver_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`ver_user` (
...
-- -----------------------------------------------------
-- Table `version-control`.`acl_classes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`acl_classes` (
...
-- -----------------------------------------------------
-- Table `version-control`.`acl_security_identities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`acl_security_identities` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `version-control`.`acl_object_identities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`acl_object_identities` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `FK_9407E54977FA751A`
    ...
    REFERENCES `version-control`.`acl_object_identities` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_unicode_ci;
...
-- -----------------------------------------------------
-- Table `version-control`.`acl_entries`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`acl_entries` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `class_id` INT(10) UNSIGNED NOT NULL,
  ...
  CONSTRAINT `FK_46C8B806DF9183C9`
    ...
    REFERENCES `version-control`.`acl_security_identities` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  ...
  CONSTRAINT `FK_46C8B806EA000B10`
    ...
    REFERENCES `version-control`.`acl_classes` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
-- Table `version-control`.`acl_object_identity_ancestors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`acl_object_identity_ancestors` (
...
-- -----------------------------------------------------
-- Table `version-control`.`project`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`project` (
  ...
  CONSTRAINT `fk_project_ver_user`
    ...
    REFERENCES `version-control`.`ver_user` (`id`)
    ON DELETE SET NULL
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `version-control`.`user_projects`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`user_projects` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_table1_project1`
    ...
    REFERENCES `version-control`.`project` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `version-control`.`issue_milestone`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`issue_milestone` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `version-control`.`issue`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`issue` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(255) NULL,
  `description` LONGTEXT NULL,
  ...
  CONSTRAINT `fk_issue_issue_milestone1`
    ...
    REFERENCES `version-control`.`issue_milestone` (`id`)
    ON DELETE SET NULL
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `version-control`.`issue_label`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`issue_label` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `version-control`.`issue_comment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`issue_comment` (
  ...
  CONSTRAINT `fk_issue_comment_issue1`
    ...
    REFERENCES `version-control`.`issue` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `version-control`.`issue_has_issue_label`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`issue_has_issue_label` (
  `issue_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_issue_has_issue_label_issue_label1`
    ...
    REFERENCES `version-control`.`issue_label` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `version-control`.`issue_event`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`issue_event` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `version-control`.`project_environment_file_perm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`project_environment_file_perm` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `version-control`.`project_environment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`project_environment` (
  ...
  CONSTRAINT `fk_project_environment_project_environment_file_perm1`
    ...
    REFERENCES `version-control`.`project_environment_file_perm` (`id`)
    ON DELETE SET NULL
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `version-control`.`project_issue_integrator`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `version-control`.`project_issue_integrator_gitlab`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `version-control`.`project_issue_integrator_gitlab` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `version-control`.`project_issue_integrator_github`
-- -----------------------------------------------------
