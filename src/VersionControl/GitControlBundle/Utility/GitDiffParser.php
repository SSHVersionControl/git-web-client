<?php
// src/VersionControl/GitControlBundle/Utility/GitDiffParser.php
namespace VersionControl\GitControlBundle\Utility;

use VersionControl\GitControlBundle\Entity\GitDiff;
use VersionControl\GitControlBundle\Entity\GitDiffLine;
