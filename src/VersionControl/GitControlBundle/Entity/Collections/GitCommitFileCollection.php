<?php
// src/VersionControl/GitControlBundle/Entity/Collections/GitCommitFileCollection.php
namespace VersionControl\GitControlBundle\Entity\Collections;

use VersionControl\GitControlBundle\Entity\GitCommitFile;
