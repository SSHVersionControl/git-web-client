...
namespace VersionControl\DoctrineEncryptBundle\DependencyInjection;
...
class VersionControlDoctrineEncryptExtension extends Extension {
    ...
    public function load(array $configs, ContainerBuilder $container) {
        ...
        $supportedEncryptorClasses = array('aes256' => 'VersionControl\DoctrineEncryptBundle\Encryptors\AES256Encryptor');
    ...
    {
        return 'versioncontrol_doctrine_encrypt';
    }
}
