...
namespace VersionControl\GitlabIssueBundle\Gitlab;

use VersionControl\GitlabIssueBundle\Gitlab\Api\ApiInterface;
use VersionControl\GitlabIssueBundle\Gitlab\Exception\InvalidArgumentException;
use VersionControl\GitlabIssueBundle\Gitlab\Exception\BadMethodCallException;
use VersionControl\GitlabIssueBundle\Gitlab\HttpClient\HttpClient;
use VersionControl\GitlabIssueBundle\Gitlab\HttpClient\HttpClientInterface;
...
class Client
{
     ...
     *
     * @param null|HttpClientInterface $httpClient Gitlab http client
     */
