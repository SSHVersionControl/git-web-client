...
namespace VersionControl\GitlabIssueBundle\Gitlab\HttpClient;
...
use VersionControl\GitlabIssueBundle\Gitlab\HttpClient\Listener\AuthListener;
use VersionControl\GitlabIssueBundle\Gitlab\HttpClient\Listener\ErrorListener;
...
class HttpClient implements HttpClientInterface
{
    protected $options = array(
        'base_url'    => 'https://git.fluid-rock.com/',

        'user_agent'  => 'php-version-control',
        'timeout'     => 10,
