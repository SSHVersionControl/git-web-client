...
class IssueMilestoneRepository extends GitlabBase implements IssueMilestoneRepositoryInterface
{
    ...
    {
        $milestoneData = array(
            'title' => $issueMilestone->getTitle(), 'description' => $issueMilestone->getDescription()
...
, 'due_date' => $issueMilestone->getDueOn()->format('c'),
    ...
    /**
     * @param int $issueMilestone
     */
    public function updateMilestone($issueMilestone)
    {
        $milestoneData = array(
                'milestone_id' => $issueMilestone->getId(), 'title' => $issueMilestone->getTitle(), 'description' => $issueMilestone->getDescription()
                //Date Format YYYY-MM-DDTHH:MM:SSZ
, 'due_date' => $issueMilestone->getDueOn()->format('c'),
                );
        $this->authenticate();
