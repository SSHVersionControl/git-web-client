...
use VersionContol\GitControlBundle\Form\UserProjectsType;
use VersionContol\GitControlBundle\Form\EditUserProjectsType;
...
class UserProjectsController extends Controller
{
    ...
    public function membersListAction($id)
    {
        ...
        $userProjects = $em->getRepository('VersionContolGitControlBundle:UserProjects')->findByProject($project);
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        $userProject = $em->getRepository('VersionContolGitControlBundle:UserProjects')->find($id);
     ...
     */
    protected function checkProjectAuthorization(\VersionContol\GitControlBundle\Entity\Project $project){
